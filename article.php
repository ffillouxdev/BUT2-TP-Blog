    ...
    ?>
        <main>
            <div class='main-article'>
                ...
                <p class='rubrique-article'><a href="./index.php">Article</a> > <?php echo htmlspecialchars($name) . " > " . htmlspecialchars($title); ?></p>
                <div class='container-article'>
                    <div class="content-article">
                        <p class="content-article-p"><?php echo nl2br(htmlspecialchars($content)); ?></p>
                        <img src='<?php echo htmlspecialchars($image); ?>assets/article/<?php echo htmlspecialchars($article['picture_article']); ?>' alt='image-article'>
                    </div>
                ...
                <div class='post-comment'>
                    ...
                    <form action="" method='POST' >
                        <textarea name="comment" placeholder='Votre réponse' class="form-textarea" maxlength="400"></textarea>
                        <p id='caractere'>0 / 400 caractères</p>
                        <button class="form-button">Poster votre réponse</button>
                    </form>
                </div>
                <?php
                if (!empty($_POST['comment'])) {
                    insertComment("test", $_POST['comment'], $article['id_article']);
